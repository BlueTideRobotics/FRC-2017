...
void GripPipeline::Process(cv::Mat& source0){
	...
	double hslThresholdHue[] = {54.72664439824973, 88.05997773158307};
	double hslThresholdSaturation[] = {64.20863309352518, 248.56060606060603};
	double hslThresholdLuminance[] = {165.10791366906477, 246.41414141414143};
