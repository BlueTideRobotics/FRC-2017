...
void GripPipeline::Process(cv::Mat& source0){
	...
	double hslThresholdHue[] = {25.589953750767716, 111.55027640173783};
	double hslThresholdSaturation[] = {20.638489208633093, 139.0909090909091};
	double hslThresholdLuminance[] = {165.10791366906477, 255.0};
