...
void GripPipeline::Process(cv::Mat& source0){
	...
	double hslThresholdHue[] = {62.82016957810583, 86.54482621643155};
	double hslThresholdSaturation[] = {98.41726618705036, 248.56060606060603};
	double hslThresholdLuminance[] = {183.45323741007195, 246.41414141414143};
	...
	double filterContoursMaxWidth = 62.0;  // default Double
