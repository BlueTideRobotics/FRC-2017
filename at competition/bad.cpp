...
//		SmartDashboard::PutNumber("gyro D", 0);
	...
	void TeleopPeriodic() {
		double initTime = timz.Get();

		SmartDashboard::PutNumber("iters", autonIters++);

		SmartDashboard::PutNumber("gyro", gyro.GetAngle());
		if (stick.GetRawButton(6)) {
			gyro.Reset();
		}
		SmartDashboard::PutNumber("1", timz.Get()-initTime);
		stick.GetRawButton(1);
		SmartDashboard::PutNumber("1.5", timz.Get()-initTime);
		...
		SmartDashboard::PutNumber("2", timz.Get()-initTime);
		...
		SmartDashboard::PutNumber("3", timz.Get()-initTime);
		// CLIMBER
		climberSet = 0.0;
		...
		SmartDashboard::PutNumber("4", timz.Get()-initTime);
//		if (timz.Get() > 100) {
...
//		}
		...
		SmartDashboard::PutNumber("5", timz.Get()-initTime);
		if (stick.GetRawButton(2)) {
			SmartDashboard::PutBoolean("vision success", updateVisionAngle());
			SmartDashboard::PutNumber("vision angle", visionAngle);
		}

		SmartDashboard::PutNumber("6", timz.Get()-initTime);
	}
